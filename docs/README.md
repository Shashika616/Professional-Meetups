...
- **04 - Decisions** — [ADR-001](04-decisions/adr-001-verified-real-world-professional-networking.md) through [ADR-009](04-decisions/adr-009-jwt-auth-strategy.md). Why we chose what we chose, so nobody re-litigates it three weeks later.
