...
- **04 - Decisions** — [ADR-001](04-decisions/adr-001-verified-real-world-professional-networking.md) through [ADR-007](04-decisions/adr-007-flutter-as-the-cross-platform-frontend.md). Why we chose what we chose, so nobody re-litigates it three weeks later.
