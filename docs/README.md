...
- **04 - Decisions** — [ADR-001](04-decisions/adr-001-verified-real-world-professional-networking.md) through [ADR-010](04-decisions/adr-010-postgresql-hosting-on-cloud-sql.md). Why we chose what we chose, so nobody re-litigates it three weeks later.
