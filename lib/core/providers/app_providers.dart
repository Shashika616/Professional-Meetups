...
final matchingServiceProvider = Provider<MatchingService>((ref) => MockMatchingService());

final selectedIntentProvider = StateProvider<IntentType>((ref) => IntentType.coffee);

final matchesProvider =
    FutureProvider.autoDispose.family<PagedResult<MatchProfile>, IntentType>(
  (ref, intent) => ref.watch(matchingServiceProvider).fetchMatches(intent: intent),
);
